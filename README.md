...
3.【详见题4.23】在题4.23中，出现了矩阵数值太大，超出了 MATLAB 限定的动态范围导致运算结果出错的问题，原题的matlab解决的方法是改变时间起点，把 1970 年作为起点来计算。在sympy中，这样的问题并未出现，sympy的数值运算可承受大小范围较matlab看上去相对有算法上的优化。<br><br>
